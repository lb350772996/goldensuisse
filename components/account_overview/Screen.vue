<template>
  <div class="debit_ammount_report" v-if="this.$store.state.loadingContent == false && data != null">
    <div
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-xl-6 col-lg-6 col-md-6">
              ...
              <div class="row gold_loard_card_welcome">
                ...
                >
                  <p class="welcome_page_active mt-3">
                    {{ numberFormatter(data.result.goldbar.profit_percent, 2) }}
                  </p>
                </div>
              </div>
              ...
              <div class="row gold_loard_card_welcome">
                ...
                >
                  <p class="welcome_page_active mt-3">
                    {{ numberFormatter(data.result.silverbar.conversion_rate / data.total_balance * 100, 2) }}
                  </p>
                </div>
                <div class="col-12 col-sm-12 col-xl-3 col-lg-3 col-md-3" v-if="valueOrPercent">
                  <p class="welcome_page_active mt-3">
            ...
            <div class="col-12 col-sm-12 col-xl-6 col-lg-6 col-md-6">
              <GChart
                id="donutchart" class="google_pie_chart_welcome"
                type="PieChart"
                :data="chartData"
